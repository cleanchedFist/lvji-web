...
function v(e) {
  return !!(function (e, t) {
    return (
      e !== t &&
      (e.replace(/www\./i, '').toLowerCase() !== t.replace(/www\./i, '').toLowerCase() ||
  ...
  var r = null,
    i = function (n, r) {
      ...
      var i = t.clientHeight,
        o = t.clientWidth;
      e.style.cssText += 'height: ' + (r || i) + 'px; width: ' + (n || o) + 'px';
    };
  return (
    n &&
      (i = (function (e, t) {
...
var b,
  ...
  g = function (e, t, n, r) {
    ...
    if (!m) {
      ...
      if (r && Object.keys(r).length && r.allow) {
        var a = r.allow instanceof Array ? r.allow : r.allow.split(';');
      ...
      for (var c in (i
        ? (o.style = 'width: ' + i.clientWidth + 'px; height: ' + i.clientHeight + 'px;')
        : ((i = document.createElement('div')).classList.add('web-office-default-container'),
          (function (e) {
      ...
      var u = n ? h(m, i) : Function.prototype;
      i.appendChild(m),
        (m.destroy = function () {
  ...
  y = function (e) {
    g().contentWindow && g().contentWindow.postMessage(JSON.stringify(e), p('origin'));
  };
function k(e, t, n) {
    ...
    return t(void 0, void 0, void 0, function () {
      ...
      return n(this, function (m) {
        switch (m.label) {
          ...
          case 1:
            (p = m.sent()), (h = p[0]), (b = p[1]), (o.args = h), (d = b), (m.label = 2);
          case 2:
            return 'api.setter' !== i ? [3, 4] : [4, S(o)];
          case 3:
            m.sent(), (m.label = 4);
          case 4:
            return (
                        ...
                        return n(this, function (n) {
                          switch (n.label) {
                            case 0:
                              return v(f)
                                ? [2]
                                : 'api.callback' === (e = r.parse(f.data)).eventName &&
                                  e.callbackId &&
                                  d[e.callbackId]
      ...
      switch (n.label) {
        ...
        case 5:
          return l < s.length
            ? ((f = s[l]),
              (d = c[f]),
              /^[A-Z]/.test(f) ? (d && d.done ? [4, d.done()] : [3, 7]) : [3, 8])
            : [3, 10];
        case 6:
          n.sent(), (n.label = 7);
        case 7:
          d && d.objId
            ? (d = { objId: d.objId })
            : 'function' == typeof d && ((p = w()), (t[p] = d), (d = { callbackId: p })),
            (n.label = 8);
        case 8:
          (a[f] = d), (n.label = 9);
        case 9:
        ...
        case 11:
          c && c.objId
            ? (a = { objId: c.objId })
            : 'function' == typeof c && void 0 === c.objId
...
var _ = function (t, n) {
    ...
    var y = [];
    if (
      ((l === u.simple || (f && !1 === f.isShowTopArea)) && y.push('simple', 'hidecmb'),
    ...
    'function' == typeof c.exportPdf &&
      ...
      delete c.exportPdf);
    return r.commandBars && N(r.commandBars, !1), e(e({}, r), { subscriptions: c });
  },
  C = function (t) {
    var n = e({}, t);
    ...
    var d = s ? 1 : 0,
      p = { token: '' };
    if (
      ('string' == typeof s ? (p.token = s) : i(s) && (p = e({ tokenData: p }, s)), d && !p.token)
    )
      return console.error('[WebOfficeSDK.init] token设置无效'), n;
    if ('string' != typeof u) throw Error('[WebOfficeSDK.init] endpoint期望为字符串');
    if (u && !u.startsWith('http'))
      return console.error('[WebOfficeSDK.init] endpoint仅支持http、https的地址'), n;
    if (((n.url = u + '/office/' + c + '/' + o + '?_w_appid=' + r + '&_w_tokentype=' + d), i(f))) {
      var v = Object.entries(f)
        .map(function (e) {
          var t = e[0],
            n = e[1];
  ...
  A = function (e) {
    ...
    if (!t && e) {
      var n = e.toLowerCase();
      -1 !== n.indexOf('/office/s/') && (t = c.spreadsheet),
        -1 !== n.indexOf('/office/w/') && (t = c.writer),
        -1 !== n.indexOf('/office/p/') && (t = c.presentation),
        -1 !== n.indexOf('/office/f/') && (t = c.pdf);
    }
    if (!t) {
...
function F() {
  var e = { status: l.requestFullscreen },
    t = document,
...
function M(i, o) {
  ...
  switch (
    ((function t(n, r, i) {
      ...
      var a = function () {
        var r = o.shift();
        !r.alias && ~q.indexOf(r.prop) && o.push(e(e({}, r), { alias: r.prop + 'Async' })),
            ...
            get: function () {
              ...
              if (!V) {
                ...
                if (!c) {
                    ...
                    l = function () {
                                    ...
                                    if (!V) {
                                      ...
                                      if (!a) {
                                        var c = K(),
                                          s = H(o),
                                          u = function () {
                                            for (var e, o = [], a = 0; a < arguments.length; a++)
                                              o[a] = arguments[a];
                                            void 0 !== r.caller
                                              ? t((e = { objId: H() }), i[r.caller], i)
                                              : (e = {});
                                            return (
                                              G(
                                                u,
                                        ...
                                        return (
                                          (u.objId = -1),
                                          void 0 !== r.getter &&
                                            ((u.objId = s), t(u, i[r.getter], i)),
                                          G(
                                            n,
                                            u,
                                            'api.getter',
                                            { parentObjId: n.objId, objId: u.objId, prop: r.prop },
                                            c,
                                            function () {
                      ...
                      return (
                        G(
                          ...
                          t,
                          'api.caller',
                          { obj: l, args: o, parentObjId: n.objId, objId: t.objId, prop: r.prop },
                          s,
                        ),
                        t
                      );
                  ...
                  return (
                    (l.objId = -1),
                    void 0 !== r.getter && ((l.objId = u), t(l, i[r.getter], i)),
                    G(
                      n,
                      l,
                      'api.getter',
        ...
        switch (n.label) {
          case 0:
            return v(e)
              ...
              ? ((i = t.data), (o = i.eventName), (a = i.data), (c = b[o]) ? [4, c(a)] : [3, 2])
              : [3, 2];
          case 1:
            n.sent(), (n.label = 2);
          case 2:
  ...
  var o = function () {
    ...
    Object.defineProperty(t, n.alias || n.prop, {
      get: function () {
        ...
        var i = n.cache === 1;
        var o = i && this['__' + n.prop + 'CacheValue'];
        if (!o) {
          var a = K();
          var c = H(i);
          var s = function () {
            ...
            return (
              G(
                ...
                o,
                'api.caller',
                { obj: u, args: e, parentObjId: t.objId, objId: o.objId, prop: n.prop },
                a,
              ),
              o
            );
...
function Y(i, o, a, c, s, u, l) {
  ...
  r.add(function (l) {
    return t(f, void 0, void 0, function () {
      var t, f, d, p, h, b, m, w, g, k, O, j, I, E, S, T, x, _, C;
      return n(this, function (n) {
        switch (n.label) {
          case 0:
            return v(l)
                      ...
                      (function (e) {
                        ...
                        Object.keys(U).forEach(function (n) {
                          ...
                          t.forEach(function (e) {
                            var t = e.eventName,
                              n = e.handle;
                            null == Z || Z.ApiEvent.AddApiEventListener(t, n);
                          });
                      })(o),
                    y({ eventName: 'setConfig', data: e(e({}, a), { version: i.version }) }),
                    i.tokenData &&
                      i.setToken(
                        e(e({}, i.tokenData), { hasRefreshTokenConfig: !!a.refreshToken }),
                      ),
                    (i.iframeReady = !0),
                    [3, 15]));
          case 1:
            return 'error' !== d ? [3, 2] : (o.emit(Q.error, h), [3, 15]);
          case 2:
            return 'open.result' !== d
              ? [3, 3]
              : (void 0 !==
                  (null === (x = null == h ? void 0 : h.fileInfo) || void 0 === x
                    ? void 0
                    : x.officeVersion) &&
                ...
                [3, 15]);
          case 3:
            return 'api.scroll' !== d ? [3, 4] : (window.scrollTo(h.x, h.y), [3, 15]);
          case 4:
          ...
          case 6:
            return (w = n.sent()), [3, 8];
          case 7:
            return (g = n.sent()), console.error('refreshToken: ' + (g || 'fail to get')), [3, 8];
          case 8:
          ...
          case 12:
            return (
              (O = n.sent()), console.error('getClipboardData: ' + (O || 'fail to get')), [3, 13]
            );
          case 13:
            return y({ eventName: X.getClipboardData + '.reply', data: k }), [3, 15];
          case 14:
            d === X.onToast
              ? s.onToast(h)
              : d === X.onHyperLinkOpen
              ...
              ? ((j = h.eventName),
                (I = h.data),
                (E = j),
                'fullScreenChange' === j && (E = Q.fullscreenChange),
                'file.saved' === j && (E = Q.fileStatus),
                ((null === (_ = a.commonOptions) || void 0 === _
                  ? void 0
                  : _.isBrowserViewFullscreen) ||
                  (null === (C = a.commonOptions) || void 0 === C
                    ? void 0
                    ...
                    ? (function (e, t, n, r) {
                        if (0 === e) {
                          if (t.dataset.pastSize) {
                            var i = JSON.parse(t.dataset.pastSize),
                              o = i.width,
                              a = i.height;
                            delete t.dataset.pastSize,
                              (t.style = 'position: static; width: ' + o + '; height: ' + a);
                          }
                        } else
                          1 === e &&
              ...
              (n.label = 15);
          case 15:
            return 'function' == typeof c[d] && c[d](i, m || h), [2];
        }
      });
    });
  });
  ...
  try {
                ...
                return (function (e, t, n) {
                  if (U[e]) {
                    ...
                    return r && 'off' === n
                      ...
                      : (r || 'on' !== n || (U[e].push(t), A.on(e, t)), !0);
                  }
                  return 'on' === n ? ((U[e] = []), U[e].push(t), !1) : 'off' === n || void 0;
                })(e, r, i)
                  ? [3, 2]
                  : [4, T];
              case 1:
                t.sent(),
                  (function (e, t) {
                    var n = e.eventName,
                      r = e.type,
                      i = e.handle;
                    'on' === t ? A.on(n, i) : A.off(n, i),
                      'base.event' === r &&
                        y({ eventName: 'basic.event', data: { eventName: n, action: t } }),
                      R();
                  })(
                    (function (e, t) {
                      var n = e,
    ...
    return (
            ...
            return n(this, function (t) {
              switch (t.label) {
                case 0:
                  return [4, T];
                case 1:
                  return t.sent(), (Z.tokenData = e), y({ eventName: 'setToken', data: e }), [2];
              }
            });
          });
        },
          ...
          return t(this, void 0, void 0, function () {
            return n(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  e.sent(), (L.apiReadySended = !0), y({ eventName: 'api.ready' }), (e.label = 2);
                case 2:
                  return [4, C];
                case 3:
                  return (
                    ...
                    [
                      ...
                      new Promise(function (e) {
                        return setTimeout(function () {
                          return e(null == Z ? void 0 : Z.Application);
                        }, 0);
                      }),
                    ]
                  );
          ...
          return t(this, void 0, void 0, function () {
            return n(this, function (t) {
              switch (t.label) {
                ...
                case 1:
                  return (
                    t.sent(), N([{ cmbId: e, attributes: [{ name: 'click', value: !0 }] }]), [2]
                  );
              }
            });
          });
      ...
      (function (e, t, n, r, i, a) {
        t && o(t) && ((i.refreshToken = t), (e.refreshToken = { eventName: X.getToken }));
        a &&
          o(a) &&
          ((i.getClipboardData = a), (e.getClipboardData = { eventName: X.getClipboardData }));
        n && o(n) && ((i.onToast = n), (e.onToast = { eventName: X.onToast }));
        r &&
          o(r) &&
          ((i.onHyperLinkOpen = r), (e.onHyperLinkOpen = { eventName: X.onHyperLinkOpen }));
      })(u, b, m, w, L, k),
      Y(Z, A, u, f, L, S),
      u.fileToken &&
        (i(u.fileToken) ? Z.setToken(e({}, u.fileToken)) : Z.setToken({ token: u.fileToken })),
      Z
    );
  } catch (e) {
    console.error(e);
...
function te(t) {
  ...
  if (
    void 0 !== i.token &&
    'string' != typeof i.token &&
    'string' != typeof (null === (n = i.token) || void 0 === n ? void 0 : n.token)
  )
    throw Error('[WebOfficeSDK.init] token类型必须为字符串！');
  if (
    void 0 !== i.fileToken &&
    'string' != typeof i.fileToken &&
    'string' != typeof (null === (r = i.fileToken) || void 0 === r ? void 0 : r.token)
  )
    throw Error('[WebOfficeSDK.init] fileToken类型必须为字符串！');
...
export { oe as OfficeType, re as config, ie as init };
