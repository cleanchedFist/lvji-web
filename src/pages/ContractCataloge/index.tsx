...
import { PageContainer, ProList, ActionType } from '@ant-design/pro-components';
import ContractSummary from './components/ContractSummary'
import { Col, Row } from 'antd';
import { getDirList } from '@/services/ant-design-pro/api';
import pollingList from './utils/pollingList'
import { ContractVersionsContext, ActionContext } from './utils/context'
...
import UploadContractModal, { UploadContractModalRef, UploadType } from './components/UploadContractModal';
...
const ContractCataloge: React.FC = () => {
  ...
  const metas = {
    ...
    content: {
      search: false, render(_: any, data: API.CatalogeCardProps) {
        return <div style={{ width: '100%' }}>
          <Row style={{ width: '100%' }}>
            ...
            <Col span={12}>
              创建时间：{formatTime(data.createTimeStamp)}
            </Col>
          </Row>
